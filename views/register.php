            ...
            <div class="card w-25 my-auto mx-auto">
                ...
                <div class="card-body">
                    <form action="../actions/register-action.php" method="post" autocomplete="off">
                        <div class="mb-3">
                            <label for="firstmname" class="form label">First Name</label>
                            <input type="text" name="firstname" id="firstname" class="form-control" autofocus required>
                        </div>
                        <div class="mb-3">
                            <label for="lastmname" class="form label">Last Name</label>
                            <input type="text" name="lastname" id="lastname" class="form-control" autofocus required>
                        </div>
                        ...
                        <input type="submit" value="Register" class="form-control btn btn-success w-100" name="btn_submit">
                    </form>
                    <p class="text-center mt-3 small">Registered Already? <a href="../views/login.php">Login</a></p>
                </div>
            </div>
        </div>
    </div>
